...
function MainBanner() {
  return (
    <div className='relative'>
        <img src={main_banner_bg} alt="banner" className='md:mt-30 w-full  hidden md:block' />
        ...
        <div className='flex items-center mt-6 font font-medium'>
          ...
          bg-primary hover:bg-primary-dull transition rounded text-white cursor-pointer'>
            Shop now
            <img className='md:hidden transition group-focus:translate-x-1' src={white_arrow_icon} alt="" />
          </Link>
